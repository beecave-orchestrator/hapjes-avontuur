...
ENTRIES = [
    ...
    # ── issue #15: meal picker titles + notes (one clip: title + note) ────
    {
        "id": "picker_title_1",
        "category": "picker",
        "text": "Wat voor soort eten heb je vandaag? Je mag zelf kiezen. Alle keuzes zijn goed.",
    ...
    {
        "id": "meal_yoghurt_kwark_pap",
        "category": "picker_name",
        "text": "Yoghurt, kwark of pap",
        "file": "meal_yoghurt_kwark_pap.mp3",
        "source": "meals.yoghurt_kwark_pap.name",
    },
    {
        "id": "meal_boterhammen",
        "category": "picker_name",
        "text": "Boterhammen",
        "file": "meal_boterhammen.mp3",
        "source": "meals.boterhammen.name",
    },
    {
        "id": "meal_pannenkoeken",
        "category": "picker_name",
        "text": "Pannenkoeken",
        "file": "meal_pannenkoeken.mp3",
        "source": "meals.pannenkoeken.name",
    },
    {
        "id": "meal_eigen",
        "category": "picker_name",
    ...
    {
        "id": "chip_eat_yoghurt_kwark_pap",
        "category": "chip",
        "text": "Je eet nu: Yoghurt, kwark of pap",
        "file": "chip_eat_yoghurt_kwark_pap.mp3",
        "source": "meal chip Je eet nu + name",
    },
    {
        "id": "chip_eat_boterhammen",
        "category": "chip",
        "text": "Je eet nu: Boterhammen",
        "file": "chip_eat_boterhammen.mp3",
        "source": "meal chip Je eet nu + name",
    },
    {
        "id": "chip_eat_pannenkoeken",
        "category": "chip",
        "text": "Je eet nu: Pannenkoeken",
        "file": "chip_eat_pannenkoeken.mp3",
        "source": "meal chip Je eet nu + name",
    },
    {
        "id": "chip_eat_pasta",
